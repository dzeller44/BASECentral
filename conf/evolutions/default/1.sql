...
create table intake (
  ...
  baassigned1                   varchar(255),
  baassignedemail1              varchar(255),
  baassignedkey1                varchar(255),
  baassigned2                   varchar(255),
  baassignedemail2              varchar(255),
  baassignedkey2                varchar(255),
  ...
  seassigned1                   varchar(255),
  seassignedemail1              varchar(255),
  seassignedkey1                varchar(255),
  seassigned2                   varchar(255),
  seassignedemail2              varchar(255),
  seassignedkey2                varchar(255),
...
drop table if exists intake_audit;

drop table if exists intake_edit;

drop table if exists lookup;

drop table if exists removed_intake;
