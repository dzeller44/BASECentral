...
class intakecreated extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
	 ...
	 """),format.raw/*2.3*/("""<section id="intakeCreated">
		...
		<form class="formoid-solid-dark"
			...
			<div class="element-input">
				<label class="title"><span class="required"></span>"""),_display_(/*10.57*/Messages("intake.save")),format.raw/*10.80*/("""</label>
			</div>
			<div class="submit">
...
object intakecreated extends intakecreated_Scope0.intakecreated
              /*
                  ...
                  HASH: 63f651050457be01938e70fcc3e899ee2066da77
                  MATRIX: 850->1|863->7|902->9|932->13|1378->432|1422->455
